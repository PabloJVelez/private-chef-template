      ...
      <div className="mt-16 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-left">
          <div className="bg-white rounded-lg p-6 shadow">
            ...
            <p className="text-sm text-gray-600">We recommend booking 1-2 weeks in advance, especially for weekend events. However, we can often accommodate shorter notice requests.</p>
          </div>
          
          <div className="bg-white rounded-lg p-6 shadow">
            <h4 className="font-semibold text-gray-900 mb-2">What's included in the service?</h4>
            <p className="text-sm text-gray-600">All ingredients, equipment, preparation, service, and cleanup are included. You just provide the location and we handle the rest.</p>
          </div>
