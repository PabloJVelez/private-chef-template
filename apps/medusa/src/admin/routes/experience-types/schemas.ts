...
export const experienceTypeSchema = z.object({
  ...
  workflow_event_type: z.enum(['cooking_class', 'plated_dinner', 'buffet_style']).default('plated_dinner'),
...
export const getDefaultExperienceTypeValues = (experienceType?: AdminExperienceTypeDTO): ExperienceTypeFormValues => {
  ...
  return {
    ...
    workflow_event_type: experienceType.workflow_event_type ?? 'plated_dinner',
